...
import io.github.yanburigo.integrationtests.testcontainers.AbstractIntegrationTest;
...
class PersonRepositoryTest extends AbstractIntegrationTest {
    ...
    void testGivenPersonList_whenFindAll_thenReturnPersonList() {
        ...
        Person person1 = new Person("Yan2",
                "Burigo",
                "yan2@erudio.com.br",
                "Sao Paulo - Sao Paulo - Brasil", "Male");
    ...
    void testGivenPersonObject_whenUpdatePerson_thenReturnUpdatedPersonObject() {
        ...
        // When / Act
        Person savedPerson = repository.findById(person0.getId()).get();
        savedPerson.setFirstName("Yan2");
        savedPerson.setEmail("yan2@gmail.com");
        
        Person updatedPerson = repository.save(savedPerson);
        
        // Then / Assert
        assertNotNull(updatedPerson);
        assertEquals("Yan2", updatedPerson.getFirstName());
